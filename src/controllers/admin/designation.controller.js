...
const getDesignationWma = async (req, res) => {
    ...
    let designationQuery = `SELECT d.*  FROM designation d LEFT JOIN untitled u ON u.untitled_id = d.untitled_id WHERE d.status = 1 AND u.category=2 AND d.untitled_id = ${untitled_id} ORDER BY d.cts DESC`;
    try {
